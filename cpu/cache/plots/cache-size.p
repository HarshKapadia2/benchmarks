...
set output "element-access-time.png"

unset key

set title "Element Access Time (64-core CPU - L1d: 32 kB, L2: 512 kB, L3: 32 MB)"
...
plot "samples/cache-size.dat" using 2
set terminal pop
...
plot "samples/cache-size.dat" using 1:2 with \
	linespoints \
	linetype 7 \
	linecolor "black"
